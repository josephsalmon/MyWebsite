...
<div class="gradient_bg">
    <div class="hero section_padding">
        <div class="hero_content">
            ...
            <p>I am a statistician and an applied mathematician at Inria (Iroko), with a strong interest in machine learning, optimization and data science. In terms of applications, I focus on <strong>citizen science</strong>, <strong>crowdsourcing</strong> and <strong>high dimensional statistics</strong>.</p>
            <h2>Short bio </h2>
...
I am always looking for outstanding and highly motivated people to work (as intern, Ph.D. student, post-doctorate or research engineer) on machine learning, and more precisely on:
