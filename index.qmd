...
<div class="gradient_bg">
    <div class="hero section_padding">
        <div class="hero_content">
            ...
            <p>I am a statistician and an applied mathematician at <a href="https://www.inria.fr/" target="_blank"><span style='text-decoration: underline;text-decoration-color: #f08f04ff;'>Inria</span></a> (team Iroko), with a strong interest in machine learning, optimization and data science. In terms of applications, I focus on <strong>citizen science</strong>, <strong>crowdsourcing</strong> and <strong>high dimensional statistics</strong>.</p>
            <h2>Short bio </h2>
