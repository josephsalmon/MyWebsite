...
format:
  html:
    ...
    theme:
      light: [html/styles_dark.scss,html/landing_page_styles.scss]
      dark: [superhero,html/styles_dark.scss]
listing:
  - id: blog-listing
    sort: 'date desc'
    contents:
...
<div class="gradient_bg">
    <div class="hero section_padding">
        <div class="hero_content">
            ...
            <p>I am a statistician and applied mathematician, specializing in machine learning, optimization, and data science.
            <br>
            Since Oct. 2024, I have been serving as a Senior Researcher at <a href="https://www.inria.fr/" target="_blank"><span style='text-decoration: underline;text-decoration-color: #f08f04ff;'>Inria</span></a> (within the <a href="https://team.inria.fr/iroko/"><span style='text-decoration: underline;text-decoration-color: #f08f04ff;'>Iroko</span></a> team), actively contributing to the <a href="https://plantnet.org/en/">Pl@nNet</a> project.
            I focus on <strong>citizen science</strong>, <strong>crowd-sourcing</strong> and <strong>high dimensional statistics</strong>.
            I also lead the doctoral program "Statistics and Data Science (SSD)" (<a href=https://edi2s.umontpellier.fr/" target="_blank"><span style='text-decoration: underline;text-decoration-color: #f08f04ff;'>EDI2S</span></a> at <a href="https://www.umontpellier.fr/" target="_blank"><span style='text-decoration: underline;text-decoration-color: #f08f04ff;'>Université de Montpellier</span></a>). </p>
...
- **July. 2026**: Come and join us for [CAP/RFIAP](https://caprfiap2026.sciencesconf.org/), CAp (Conférence sur l'Apprentissage automatique) and RFIAP (Reconnaissance des Formes, Image, Apprentissage et Perception) conferences.
- **Sept. 2024**: I've joined Inria as a senior researcher (Team: Iroko, Montpellier)
- **Sept. 2023**: ANR VITE accepted  (PI: B. Thirion; Theme: variable importance / explainability).
...
- **Nov. 2020**: Launching [ML-MTP Machine Learning in Montpellier, Theory & Practice](https://isdm.umontpellier.fr/les-halles-de-lia/machine-learning-in-montpellier-theory-practice/).
