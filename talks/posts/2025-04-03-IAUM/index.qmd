...
- **Annecdote**: découverte grâce à mon père, un passionné de botanique [Patrice Salmon](https://identify.plantnet.org/fr/users/100504685) 
</div>
...
- **Données** : images de plantes
- **Etiquettes** : noms des plantes
- **Modèle (architecture)** : réseau de neurones
- **Algorithme** : sert à optimiser les performances du modèle
...
<center>
![](images/WMV_simley.svg){width="95%"}
</center>
<!-------------------------------------------------------------------------- -->
