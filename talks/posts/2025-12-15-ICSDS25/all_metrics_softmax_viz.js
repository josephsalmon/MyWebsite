...
if (document.readyState === 'loading') {
  ...
  // DOM already loaded (e.g., in RevealJS)
  setTimeout(initializeSoftmaxViz, 100);
}

// For RevealJS: reinitialize when slide becomes visible
if (typeof Reveal !== 'undefined') {
  ...
  Reveal.on('slidechanged', function(event) {
    if (event.currentSlide.querySelector('#all-metrics-softmax-container')) {
      setTimeout(initializeSoftmaxViz, 100);
    }
  });
}
