...
The optimal set $\mathcal{C}$ of minimum size and **marginal coverage** of at least $1-\alpha$ is:
...
The optimal set $\mathcal{C}$ of minimum size and **conditional coverage** of at least $1-\alpha$ is:
...
The optimal set $\mathcal{C}$ of minimum size and **Macro-Coverage** of at least $1-\alpha$ is:
