...
<style>
/* -------------------------------------------------------------------------- */
/* Global typography, SVGs, references, image cards, statistics and bias UI */
/* -------------------------------------------------------------------------- */
...
.stat-users { grid-column: 1; grid-row: 1; }
.stat-queries { grid-column: 1; grid-row: 2; }
.stat-species { grid-column: 3; grid-row: 1; }
.stat-observations { grid-column: 3; grid-row: 2; }
.stat-storage { grid-column: 1 / -1; grid-row: 3; }
...
@media (max-width: 700px) {
  ...
  .stat-tree { grid-column: 1 / -1; grid-row: 1; }
  .stat-users { grid-column: 1; grid-row: 2; }
  .stat-species { grid-column: 2; grid-row: 2; }
  .stat-queries { grid-column: 1; grid-row: 3; }
  .stat-observations { grid-column: 2; grid-row: 3; }
  .stat-storage { grid-column: 1 / -1; grid-row: 4; }
}

/* PlantNet interactive filter menus */
#filter-container > div,
#filter-container-2 > div {
  padding: 5px !important;
  max-width: 100% !important;
}

#filter-container > div > div:first-child,
#filter-container-2 > div > div:first-child {
...
#filter-container-2 > div > div:last-child {
  gap: 5px !important;
...
@media (max-width: 800px) {
  .biases-grid { grid-template-columns: 1fr; }
  .bias-card { min-height: auto; }
}

/* Image grid / team helpers */
...
.team-member img + p { margin-top: -2px !important; }
</style>
