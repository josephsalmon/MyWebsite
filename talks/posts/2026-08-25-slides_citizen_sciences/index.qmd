...
.stat-users        { grid-area: 1 / 1; }
.stat-queries      { grid-area: 2 / 1; }
.stat-species      { grid-area: 1 / 3; }
.stat-observations { grid-area: 2 / 3; }
.stat-storage      { grid-area: 3 / 1 / 4 / -1; }
...
.stat-tree img {
  display: block;
  width: 100%;
  max-width: none;   /* was 300px — this was the actual bug */
  height: auto;
  max-height: 100%;
  margin: 0 auto;
  object-fit: contain;
...
@media (max-width: 700px) {
  ...
  .stat-tree         { grid-area: 1 / 1 / 2 / 3; }
  .stat-users        { grid-area: 2 / 1; }
  .stat-species      { grid-area: 2 / 2; }
  .stat-queries      { grid-area: 3 / 1; }
  .stat-observations { grid-area: 3 / 2; }
  .stat-storage      { grid-area: 4 / 1 / 5 / 3; }
}


/* -------------------------------------------------------------------------- */
/* PlantNet interactive filter menus                                          */
/* -------------------------------------------------------------------------- */

:is(#filter-container, #filter-container-2) > div {
  padding: 5px !important;
  max-width: 100% !important;
}

:is(#filter-container, #filter-container-2) > div > div:first-child {
  margin-bottom: 2px !important;
  padding-bottom: 2px !important;
  font-size: 12px !important;
}

:is(#filter-container, #filter-container-2) > div > div:last-child {
  gap: 5px !important;
  grid-template-columns: repeat(4, 1fr) !important;
}

:is(#filter-container, #filter-container-2) > div > div:last-child > div:nth-child(n + 2) {
  display: contents !important;
}

:is(#filter-container, #filter-container-2) div[role="heading"] {
  display: none !important;
}

:is(#filter-container, #filter-container-2) label {
  margin-left: 4px !important;
  font-size: 10px !important;
}

:is(#filter-container, #filter-container-2) .status-color-box {
  width: 10px !important;
  height: 10px !important;
  margin-right: 4px !important;
}

:is(#filter-container, #filter-container-2) input[type="checkbox"] {
  margin: 0 !important;
  transform: scale(0.7);
}

:is(#filter-container, #filter-container-2) > div > div:last-child > div:first-child label {
  font-size: 11px !important;
}

:is(#filter-container, #filter-container-2) > div > div:last-child > div > div {
  padding: 0 !important;
}
...
/* Classification challenges overview */
...
### {{< iconify game-icons:palm-tree >}} {{< iconify game-icons:pine-tree >}} {{< iconify game-icons:fruit-tree >}} Plant importance
<hr>
...
<img src="images/biomass_tall.svg" width="50%" align="middle" >

Biomass on earth  [@bar2018biomass]
...
- [Provisioning]{.underline}: Food, Medicines ...

<div class="img-author-container" style="width:90%; min-width:120px;margin-left: auto;">
  <img src="images/European_honey_bee_extracts_nectar_wide.jpg" alt="Honey bee" class="img-author-img" style="width:95%;">
  <span class="img-author-overlay" style="font-size: 0.6rem;top: 15%; right: 5%;">John Severns<br>Public domain</span>
</div>




- [Supporting]{.underline}: Photosynthesis, soil formation, water cycle, ...

<div class="img-author-container" style="width:75%; min-width:120px;margin-left: auto;">
  <img src="images/Grib_skov_wide.png" alt="Leaves on the ground, in a forest" class="img-author-img" style="width:75%%;">
    <span class="img-author-overlay" style="font-size: 0.6rem;top: 15%; right: 5%;">Malene Thyssen<br>Public domain</span>
  <!-- <span class="img-author-overlay" style="font-size:.4rem">Malene Thyssen<br>Public domain</span> -->
</div>
...
<div class="img-author-container" style="width:60%; min-width:120px;margin-right: auto;">
  <img src="images/a651d2e4e24c278ec1ac96d7e567f712cd67659b.jpeg" alt="Leaves on the ground, in a forest" class="img-author-img" style="width:60%;">
    <span class="img-author-overlay" style="font-size: 0.6rem;top: 15%; right: 5%;"> Lynette Schimming − EOL <br>CC-BY-NC</span>
</div>




- [Regulating]{.underline}: Pollination, Climate, ...

<div class="img-author-container" style="width:19%; min-width:120px;margin-right: auto;">
  <img src="images/Gmelina_leaves_forest_floor.jpeg" alt="Leaves on the ground, in a forest" class="img-author-img" style="width:19%;">
  <span class="img-author-overlay" style="font-size: 0.6rem;top: 15%; right: 5%;">fuerst.ernst<br>CC-BY-SA</span>
</div>


- [Cultural]{.underline}:  Places for recreation, wonder, ...
...
<div style="display: flex; justify-content: space-between; font-size: 5rem; align-items: center; width: 100%; padding: 0 2rem;">Pl@ntNet insight<br><br><br><br><img src="images/plantnet_icone_square_white.svg" alt="Tree with roots" width="25%"></div>
...
<img src="../2024-09-25_slides_sierra/images/plantnet_app.jpg" width="55%" align="middle" style="border-radius:5%">
...
<center>
<img src="images/PlantNet-overview-August-2026_en.svg" width="70%" >
</center>
...
<!------------------------------------------------------------------------ -->
<!-- ### {{< iconify hugeicons:chatting-01 >}} Pl@ntNet: Importance & usage
<hr>

<div style="text-align: center;">

<img src="images/biomass.svg" width="20%" align="middle" >
...
::: {.column width="40%" style="padding: 0.5rem;"}
...
::: {.column width="55%" style="padding: 0.5rem;"}
...
def scrape_team():
    ...
    if not team:
        raise ValueError("No team members parsed.")
    return team
...
for m in team:
    links = " | ".join(
        f'<a href="{x["href"]}">{x["label"]}</a>'
        for x in m["links"]
    )
    print(
        f'<div class="team-member" id="{m["id"]}">'
        f'<img src="{m["img"]}" '
        f'style="border-radius:100px;width:85px;height:85px;object-fit:cover;">'
        f'<p style="text-align:center;">'
        f'<strong>{m["name"]}</strong><br>'
        f'{m["role"]}<br>{links}</p>'
        f'</div>'
    )
...
- **Prediction uncertainty quantification** <br> with long tail data [@Ding_Fermanian_Salmon25]: providing prediction sets with statistical guarantees with Conformal Prediction
...
<div style="display: flex; justify-content: space-between; font-size: 4rem; align-items: center; width: 100%; padding: 0 2rem;">Pl@ntNet,<br>challenging standard ML assumptions <img src="images/roots_icon.svg" alt="Tree with roots" width="25%"></div> 
<!------------------------------------------------------------------------ -->


<!------------------------------------------------------------------------ -->
### {{<iconify mdi:puzzle-outline>}} Pl@ntNet classification challenges
<hr>
...
<div class="challenge-icon">{{<iconify tabler:stack-2>}}</div>
...
<div class="challenge-icon">{{<iconify tabler:binary-tree>}}</div>
...
<div class="challenge-icon">{{<iconify mdi:scale-balance>}}</div>
...
<img src="images/Diversity_of_plants_(Streptophyta)_version_2.png" alt="Diversity of plants" style="width: 100%; height: auto; max-height: 100%; object-fit: contain;">
<span class="img-author-overlay" style="font-size: 0.6rem; top: 90%; left: 50%; transform: translateX(-50%); text-align: center; padding: 6px 20px; display: inline-block; min-width: 100px;"> Rkitko <br> (Wikimedia Commons)</span>
</div>
...
[Source]{.underline}: <a href="https://identify.plantnet.org/en/stats">Pl@ntNet stats</a>
...
<div style="display: flex; justify-content: space-between; font-size: 4rem; align-items: center; width: 100%; padding: 0 2rem;"> Bias in Citizen Science Data<br><br><br><br><br><br><img src="images/biais.svg" alt="Tree with roots" width="25%"></div>
...
<div style="display: flex; justify-content: space-between; font-size: 4rem; align-items: center; width: 100%; padding: 0 2rem;">The Pl@ntNet-300K dataset<br><br><br><br><img src="images/1538174846_tree_root_simplified_white.svg" alt="Tree with roots" width="25%"></div>
...
@Krizhevsky09: "*Furthermore, we personally verified every label submitted by the labelers*", on CIFAR10 & CIFAR100 paper  
...
<style>
/* Interactive visualizations: shared Nunito/Plotly styling */
#plantnet-viz,
#plantnet-viz *,
#plots2,
#plots2 *,
...
/* PlantNet interactive: bold controls/caption/legend axes */
...
/* Preserve the existing cascade of the metric visualizations:
   the original malformed selector lists applied width: 900px to
   these elements, while the later rules narrowed the legend box. */
...
<center>
<div style="font-size: 4rem; text-align: center; width: 100%; padding: 0 2rem;">
Uncertainty quantification with long-tail<br><br>
<img src="images/long_tail.svg" alt="Long tail plot" width="80%">
</div>
...
{{< iconify mdi:arrow-right-bold >}} **In classification**: a common conformal score is $s(x,y) = \hat{p}(y|x)$ (*e.g.,* softmax scores).
...
<!-- XXX: inverser l'ordre + naming wrong. -->
...
<script type="module"
        src="all_metrics_softmax_viz_no_yellow.js">
</script>
```
<center>
...
For user-chosen class weights $\omega$  with $\omega(y)\geq 0$ and $\sum_{y \in \mathcal{Y}} \omega(y)=1$, define the _$\omega$-weighted macro-coverage_ :
...
- Pl@ntNet-300K-v2: [https://zenodo.org/records/10419064](https://zenodo.org/records/10419064)
- Pl@ntNet-CrowdSWE: [https://zenodo.org/records/10782465](https://zenodo.org/records/10782465)
:::
::::
...
- Improve label **agregation**, leverage gamification  (*e.g.*, [theplantgame.com](https://theplantgame.com)), etc.
:::
::::
<!-------------------------------------------------------------------------- -->
