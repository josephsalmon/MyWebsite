...
<div style="display: flex; justify-content: space-between; font-size: 1.em; align-items: center; width: 100%; padding: 0 2rem;">Pl@ntNet,<br>challenging standard ML assumptions <img src="images/roots_icon.svg" alt="Tree with roots" width="25%"></div> 
<!------------------------------------------------------------------------ -->
