...
(function() {
  ...
  const southWest = L.latLng(-MERCATOR_LAT_LIMIT, -180);
  const northEast = L.latLng(MERCATOR_LAT_LIMIT, 180);
  ...
  sliderEl.noUiSlider.on('update', function(values) {
    ...
    occurrenceLayer = L.tileLayer(gbifTileUrl(year), {
      attribution: 'Occurrence data © GBIF',
      noWrap: true,
      bounds: mercatorBounds
    }).addTo(map);
...
### Pl@ntNet : a citizen science dataset
...
<img src="images/1538174846_tree_root.svg" alt="Tree with roots">
