...
- Provisioning:<br> Food, Medicines ...

<div class="img-author-container" style="width:90%; min-width:120px;margin-left: auto;">
  <img src="images/European_honey_bee_extracts_nectar_wide.jpg" alt="Honey bee" class="img-author-img" style="width:100%;">
  <!-- <span class="img-author-overlay" style="font-size:.4rem">John Severns<br>Public domain</span> -->
</div>




- Supporting:<br> Photosynthesis, soil formation, water cycle, ...

<div class="img-author-container" style="width:75%; min-width:120px;margin-left: auto;">
  <img src="images/Grib_skov_wide.png" alt="Leaves on the ground, in a forest" class="img-author-img" style="width:100%;">
...
<div class="img-author-container" style="width:19%; min-width:120px;margin-right: auto;">
  <img src="images/Prunus_spinosa_L_1023984740.svg" alt="Prunus spinosa L." class="img-author-img" style="width:100%;">
  <!-- <span class="img-author-overlay" style="font-size:0.4rem">fuerst.ernst<br>CC-BY-SA</span> -->
</div>




- Regulating:<br> Pollination, Climate, ...

<div class="img-author-container" style="width:19%; min-width:120px;margin-right: auto;">
  <img src="images/Gmelina_leaves_forest_floor.jpeg" alt="Leaves on the ground, in a forest" class="img-author-img" style="width:100%;">
  <!-- <span class="img-author-overlay" style="font-size:.4rem">Poyt448 Peter Woodard<br>Public domain</span> -->
</div>


- Cultural:<br> Places for recreation, wonder, ...
...
<!------------------------------------------------------------------------ -->
### Pl@ntNet: Supervised learning Mutliclass classification challenges

- **massive size**: 
    - huge amount of samples (images)
    - huge amount of classes (species)

- highly **structured** labels
  - **hierarchical** label structure (tree of life)
  - confusions labels

- **biased** citizen-science dataset
...
<span class="img-author-overlay" style="font-size: 0.6rem;top: 90%; right: 15px;">@ Rkitko (Wikimedia Commons)</span>
</div>
