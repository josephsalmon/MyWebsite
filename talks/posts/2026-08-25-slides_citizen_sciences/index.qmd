...
<center>
<span style="font-size: 2.2em;"> {{<iconify ion:warning-outline>}}
</span>

 **<span style="font-size: 1.2em;"> more observations ≠ a more representative dataset</span>**
</center>
...
<!-------------------------------------------------------------------------- -->
### {{<iconify gravity-ui:magnifier>}} "Frictionless Reproducibility" & new benchmarks
<hr>
...
**⤷ Pl@ntNet-300K:** A curated, shareable subset of Pl@ntNet, adhering to **FR-1: Datafication and Data Sharing** for frictionless reproducibility [@donoho2024data]:
