...
```{=html}
<div style="display: flex; gap: 2vw; max-width: 60%; margin: 0 auto; align-items: flex-start; justify-content: center;">
    <div style="width: 40%; text-align: center; position: relative;">
        <img src="images/Diversity_of_plants_(Streptophyta)_version_2.png" alt="Diversity of plants (Streptophyta)" style="width: 100%; height: auto; max-height: 350px; object-fit: contain;">
        <span class="img-author-overlay">@ Rkitko (Wikimedia Commons)</span>
        <div style="font-size: 0.75em; margin-top: 5px;">Diversity of plants (400K+ species)</div>
    </div>
    <div style="width: 55%; text-align: center; position: relative;">
        <img src="images/03. Angiosperm Tree of Life_RBG_Kew_36_ppi.jpg.webp" alt="Angiosperm Tree of Life" style="width: 100%; height: auto; max-height: 350px; object-fit: contain;">
  ...
  <div id="plotly-container" style="flex: 4; height: 400px; width: 65vw; max-width: 65vw; min-width: 200px;"></div>
    ...
    <div style="flex: 1; min-width: 280px; display: flex; flex-direction: column;">
      ...
      <div id="image-preview-container" style="display: flex; flex-direction: column; justify-content: flex-start; align-items: center; flex: 1;">
        ...
        <img id="preview-image" src="" style="max-width: 100%; width: 35vw; max-height: calc(100vh - 300px); min-height: 100px; border: 1px solid #ccc; display: none; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); object-fit: contain;" />
...
<!-------------------------------------------------------------------------- -->
### {{<iconify icon-park-solid:chart-histogram-two>}} Conformal Prediction [@vovk2005algorithmic]
<hr>
...
Best control: (label) class-conditional coverage,

But, with long-tail useless 
...
{{< iconify mdi:arrow-right-bold >}} Introduce a new conformal score,  **Wighted Prevalence Adjusted Softmax (WPAS)** : $s(x,y) = -\omega(y) \frac{\hat{p}(y|x)}{\hat{p}(y)}$
