...
<div style="display: flex; gap: 2vw; max-width: 60%; margin: 0 auto; align-items: flex-start; justify-content: center;">
    <div style="width: 40%; text-align: center; position: relative;">
        <img src="images/Diversity_of_plants_(Streptophyta)_version_2.png" alt="Diversity of plants (Streptophyta)" style="width: 100%; height: auto; max-height: 450px; object-fit: contain;">
...
{{< iconify mdi:arrow-right-bold >}} **In classification**: a common conformal score is $s(x,y) = \hat{p}(y|x)$ (= softmax score in deep learning)
