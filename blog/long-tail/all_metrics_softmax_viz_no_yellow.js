// All Metrics Softmax Pareto Visualization (No Yellow/PAS version)
...
async function createSoftmaxPlot_NoYellow(data) {
  ...
  // Add vertical dashed lines at alpha values on the 3rd subplot (MarginalCov)
  data.targetAlphas.forEach(alpha => {
    ...
    traces.push({
      ...
      xaxis: 'x3',  // 3rd subplot (MarginalCov)
      yaxis: 'y3',
  ...
  const layout = {
    ...
    // X-axis configurations for 3 metric subplots
    xaxis: {
      domain: [0, 0.30],
