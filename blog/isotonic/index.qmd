...
Below you'll find a visualization, on a synthetic dataset, of the most common algorithm, the Pools Adjacent Violators Algorihtm (PAVA) to solve isotonic regression algorithm.
...
# x = np.arange(n_sample)
# z = rng.integers(-20, 50, size=(n_sample,)) + 50. * np.log(1 + np.arange(n_sample))
