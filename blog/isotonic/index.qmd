...
:::: {.proof-container}
::: {.proof-header onclick="toggleProof('lem-polar')"}
[▶]{#proof-arrow-lem-polar .proof-arrow} [Proof]{.proof-title}
:::

::: {#proof-content-lem-polar .proof-content}
...
:::: {.proof-container}
::: {.proof-header onclick="toggleProof('thm-dual')"}
[▶]{#proof-arrow-thm-dual .proof-arrow} [Proof]{.proof-title}
:::

::: {#proof-content-thm-dual .proof-content}
...
:::: {.proof-container}
::: {.proof-header onclick="toggleProof('thm-kkt')"}
[▶]{#proof-arrow-thm-kkt .proof-arrow} [Proof]{.proof-title}
:::

::: {#proof-content-thm-kkt .proof-content}
...
Each block B can be written as $B = \llbracket \underline{b}, \overline{b} \rrbracket$ for some $\underline{b} \leq \overline{b}$ and $x^{\star}_{\underline{b}} = x^{\star}_{\underline{b}+1} = \ldots = x^{\star}_{\overline{b}}$.
When needed, we use the convention $x^{\star}_{0}=0$ and $x^{\star}_{n+1}=0$. Then, note that by definition of a block, $x^{\star}_{\underline{b}-1}<x^{\star}_{\underline{b}}$ and $x^{\star}_{\overline{b}}<x^{\star}_{\overline{b}+1}$, and by complementarity $\alpha^{\star}_{\underline{b}-1} = \alpha^{\star}_{\overline{b}} = 0$.

Summing over the elements of $B$ in @eq-stationarity yields (telescopic sum):
$$
\begin{align*}
\sum_{i \in B }w_i (x^{\star}_i - y_i) +  \alpha_{\overline{b}}^{\star} - \alpha_{\underline{b}-1}^{\star} & = 0 \enspace.
\end{align*}
$$
...
:::: {.proof-container}
::: {.proof-header onclick="toggleProof('lem-lambda')"}
[▶]{#proof-arrow-lem-lambda .proof-arrow} [Proof]{.proof-title}
:::

::: {#proof-content-lem-lambda .proof-content}
...
:::: {.proof-container}
::: {.proof-header onclick="toggleProof('thm-convergence')"}
[▶]{#proof-arrow-thm-convergence .proof-arrow} [Proof]{.proof-title}
:::

::: {#proof-content-thm-convergence .proof-content}
...
## Further reading
For readers interested in generalization of isotonic regression (to partial orders in particular), one can check the book by @robertson1988order.


# Acknowledgement
I am grateful to Hugo Negrel for his kind help, catching a few typos in the first version of the post.
