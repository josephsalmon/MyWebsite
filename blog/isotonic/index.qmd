...
def plot_targets(y, targets, x):
    ...
    # legend1=dict(yanchor="top", y=0.99, xanchor="left", x=0.99, yref='paper'),
    # legend2=dict(yanchor="top", y=0.19, xanchor="left", x=0.99, yref='paper',
    # visible=True,
        # )
    )
...
# fig2 = go.Fig2ure()
# fig2.add_trace(go.Scatter(x=np.arange(len(duals)), y=duals, mode='lines+markers', name='Duals', marker=dict(color='green')))
# fig2.add_trace(go.Scatter(x=np.arange(len(primals)), y=primals, mode='lines+markers', name='Primals', marker=dict(color='blue')))

# fig2.update_layout(
#     title='Duals and Primals Evolution',
