...
author:
  ...
  - name: François-David Collin
    url: https://fradav.perso.math.cnrs.fr/
...
:::: {.proof-container}
::: {.proof-header onclick="toggleProof('thm-lfgn')"}
[▶]{#proof-arrow-thm-lfgn .proof-arrow} [Proof]{.proof-title}
:::

::: {#proof-content-thm-lfgn .proof-content}
...
:::: {.proof-container}
::: {.proof-header onclick="toggleProof('thm-invariance')"}
[▶]{#proof-arrow-thm-invariance .proof-arrow} [Proof]{.proof-title}
:::

::: {#proof-content-thm-invariance .proof-content}
...
:::: {.proof-container}
::: {.proof-header onclick="toggleProof('thm-rescaling')"}
[▶]{#proof-arrow-thm-rescaling .proof-arrow} [Proof]{.proof-title}
:::

::: {#proof-content-thm-rescaling .proof-content}
